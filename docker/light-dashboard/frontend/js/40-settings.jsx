                                        ...
                                        <div class="mt-6 space-y-6">
                                            ...
                                            <div class="bg-[#181825] border border-[#313244] rounded-xl p-5">
                                                ...
                                                {/* --home is passed explicitly even though the
                                                    ...
                                                    guess and this is not: the update runner picks
                                                    ...
                                                    actually wrote. */}
                                                <div class="space-y-2">
                                                    <CommandLine command={`${home}/update --to vX.Y.Z --home ${home} --dry-run`} />
                                                    <CommandLine command={`${home}/update --to vX.Y.Z --home ${home}`} />
                                                </div>
                                                <p class="text-[11px] text-[#585b70] mt-4 leading-relaxed">
